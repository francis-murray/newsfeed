...
def convert_structtime_to_dt(structtime: time.struct_time, iana_timezone="America/Los_Angeles"):
    ...
    Args:
        ...
        iana_timezone (str, optional): IANA timezone string. Defaults to "America/Los_Angeles".
    ...
    # Attach timezone info (e.g. 2025-07-21 16:25:47-07:00)
